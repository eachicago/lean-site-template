...
Effective altruism is a global movement built around using evidence and reason to work out how to help others most, and then acting on the answer. If it's new to you, start with [what is effective altruism?](/effective-altruism), then the [FAQ](/faq) for the questions people usually ask next, and the [reading material](/effective-altruism#reading-material) when you want to go deeper.

#### Get involved

The easiest first step is to [come to something](/calendar). You can also [subscribe to the newsletter](https://eachicago.substack.com/), [join us on Slack](https://join.slack.com/t/eachicago/shared_invite/zt-1mbxr5ol3-9WhuX7l19p~HYEXFD_rG0g), or just [email us](mailto:info@eachicago.com) — we're happy to answer questions, and equally happy to point you somewhere better if we're not what you're looking for.
